...
function Approval({ approvalData, loading, closeModal }) {
  ...
  const handleFormSubmit = (e) => {
    ...
    // Validate the loan status for the requested action
    const validStatusForAction = {
      approve: ["processed"],
      cancel: ["approved", "processed", "paying"],
      reject: ["applied", "processed"],
      close: ["approved", "paid", "paying"],
    };

    const allowedStatuses = validStatusForAction[activeForm];

    if (!allowedStatuses?.includes(approvalData?.status)) {
      setError(
        ...
        <div className={styles.viewLoanDetails}>
          <div>
            ...
            <p>
              ...
              {capitalizeWords(approvalData?.loan_type)}
            </p>
            <p>
              <strong>Loan Purpose:</strong>{" "}
              {capitalizeWords(approvalData?.loan_purpose)}
            </p>
            <p>
            ...
            <p>
              <strong>Status:</strong> {capitalizeWords(approvalData?.status)}
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              {capitalizeWords(approvalData?.approved_by) || "N/A"}
            </p>
            <p>
          ...
          <div>
            ...
            <p>
              ...
              {capitalizeWords(approvalData?.first_review)}
            </p>
            <p>
              <strong>First Reviewer:</strong>{" "}
              {capitalizeWords(approvalData?.first_reviewer) || "N/A"}
            </p>
            <p>
            ...
            <p>
              ...
              {capitalizeWords(approvalData?.second_review)}
            </p>
            <p>
              <strong>Second Reviewer:</strong>{" "}
              {capitalizeWords(approvalData?.second_reviewer) || "N/A"}
            </p>
            <p>
          ...
          <div>
            ...
            <p>
              ...
              {capitalizeWords(approvalData?.full_name)}
            </p>
            <p>
            ...
            {approvalData?.co_debtor === "yes" ? (
              <>
                <p>
                  <strong>Co-Debtor:</strong>{" "}
                  {capitalizeWords(approvalData?.co_debtor)}
                </p>
                <p>
                  <strong>Co-Debtor Name:</strong>{" "}
                  {capitalizeWords(approvalData?.co_debtor_name)}
                </p>
                <p>
                  <strong>Co-Debtor Relation:</strong>{" "}
                  {capitalizeWords(approvalData?.co_debtor_relation)}
                </p>
              </>
            ) : (
              <p>
            ...
            <p>
              ...
              {capitalizeWords(approvalData?.prior_loan_history)}
            </p>
            <p>
              <strong>Owe Arrears Elsewhere:</strong>{" "}
              {capitalizeWords(approvalData?.owe_arrears_elsewhere)}
            </p>
          </div>
          ...
          <div>
            <h4>Consent</h4>
            <p>
              <strong>Consent:</strong> {capitalizeWords(approvalData?.consent)}
            </p>
            <p>
