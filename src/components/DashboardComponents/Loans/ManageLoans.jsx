...
import styles from "./ManageLoans.module.css";
...
const ManageLoanTable = ({
  ...
  const totalPages = Math.ceil(myLoans?.length / loansPerPage);
  const indexOfLastLoan = currentPage * loansPerPage;
  const indexOfFirstLoan = indexOfLastLoan - loansPerPage;
  const currentLoans = myLoans?.slice(indexOfFirstLoan, indexOfLastLoan);
