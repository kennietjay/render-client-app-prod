...
const PaginatedActiveLoans = ({
  ...
  const currentLoans = activeLoans?.slice(startIdx, startIdx + itemsPerPage);
      ...
      <div className={styles.loanContent}>
        ...
        {isSidebarOpen && (
          <div className={styles.sidebar}>
            ...
            <div>
              <button>Revie Loan</button>
              <button>Pay Loan</button>
              <button>Close loan</button>
            </div>
          </div>
        )}
      </div>
...
export default PaginatedActiveLoans;
