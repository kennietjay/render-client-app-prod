...
function SummaryForm({ prevStep, formData, onSubmit, handleCloseModal }) {
                  ...
                  <div>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        {capitalizeWords(formData.employment?.employer_name)}
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        {capitalizeWords(formData.employment?.current_position)}
                      </li>
                      <li>
                      ...
                      <li>
                        <span>Address </span>:{" "}
                        {capitalizeWords(formData.employment?.employer_address)}
                      </li>
                      <li>
                        <span>City </span>:{" "}
                        {capitalizeWords(formData.employment?.employer_city)}
                      </li>
                      <li>
                        <span>Chiefdom </span>:{" "}
                        {capitalizeWords(
              ...
              <div className={styles.summaryStyle}>
                ...
                {formData.loan && (
                  <ul>
                    ...
                    <li>
                      <span>Loan Amount </span>: {formData.loan?.loan_amount}
                    </li>
                    <li>
                    ...
                    <li>
                      <span>Total Amount</span>: {formData.loan?.total_amount}
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      {capitalizeWords(formData.loan?.co_debtor_relation || "")}
                    </li>
                  </ul>
                )}
              </div>
                ...
                {formData?.guarantor && (
                  <ul>
                    ...
                    <li>
                      ...
                      {capitalizeWords(formData.guarantor?.guarantor_last_name)}
                    </li>
                    <li>
                      <span>Gender </span>:{" "}
                      {capitalizeWords(formData.guarantor?.guarantor_gender)}
                    </li>
                    <li>
                      <span>Occupation </span>:{" "}
                      {capitalizeWords(
                    ...
                    <li>
                      <span>Phone</span>: {formData.guarantor?.guarantor_phone}
                    </li>
                    <li>
                      <span>Email </span>: {formData.guarantor?.guarantor_email}
                    </li>
                    <li>
                      <span>Address</span>:{" "}
                      {capitalizeWords(formData.guarantor?.guarantor_address)}
                    </li>
                    <li>
                      <span>City/Town </span>:{" "}
                    ...
                    <li>
                      <span>Section </span>:{" "}
                      {capitalizeWords(formData.guarantor?.guarantor_section)}
                    </li>
                    <li>
                      <span>Chiefdom </span>:{" "}
                      {capitalizeWords(formData.guarantor?.guarantor_chiefdom)}
                    </li>
                    <li>
                      <span>District </span>:{" "}
                      {capitalizeWords(formData.guarantor?.guarantor_district)}
                    </li>
                  </ul>
                )}
              </div>
